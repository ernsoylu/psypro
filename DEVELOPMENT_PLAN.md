...
| 15 — Circuit designer | **Done** — the Design page is a drag-and-drop editor on the same graph as the chart; a recirculating loop resolves by tearing. See `docs/schematic-designer-plan.md` |
